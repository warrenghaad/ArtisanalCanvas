...
![Primitive Engine Rosetta Stone UML map](assets/raster/primitive-engine-rosetta-stone-map.png)
...
![Control Bend Recover diagram](assets/raster/symmetry-control-bend-recover.png)
